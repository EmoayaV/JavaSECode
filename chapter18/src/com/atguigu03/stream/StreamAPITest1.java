...
//        filter(Predicate p)——接收 Lambda，从流中排除某些元素。
        ...
        stream.filter(emp -> emp.getSalary() > 7000).forEach(System.out::println);//foreach算一个终止操作

        // Predicate函数式接口         T = Employee
        // public interface Predicate<T> {boolean test(T t);}
        //
        // 匿名实现类的方式
        // Predicate<? super Employee> predicate = new Predicate<? super Employee>(){
        ...
        //
        // lambda表达式
        // Predicate<? super Employee> predicate = emp -> emp.getSalary() > 7000

        // Consumer函数式接口         T = Employee
        // public interface Consumer<T> {void accept(T t);}
        //
        // 匿名实现类的方式
        // Consumer<? super Employee> action = Consumer<? super Employee>() {
        ...
        //
        // lambda表达式
        // Consumer<? super Employee> action = emp -> System.out.println(emp);
        //
        // 方法调用
        // Consumer<? super Employee> action = System.out::println;
