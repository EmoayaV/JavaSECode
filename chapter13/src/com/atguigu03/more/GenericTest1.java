...
//        list = list1;
    ...
    * */
    ...
    public void test3_1(){
        ...
        //写入数据：不可以的。例外：null，相当于负无穷
        //因为不能确定List<? extends Father>中的"?"究竟是什么类型，不能确定下界，如果这里的类型是Son类，那么new Father()就不行。以此类推
        list.add(null);
//        list.add(new Father());
//        list.add(new Son());
    }
...
//        list = list3;
    ...
    public void test4_1(){
        ...
        //因为确定List<? extends Father>中的"?"的下界，如果这里的下界是Father()类型，那么就可以new Son()类型。以此类推
        list.add(null);
//        list.add(new Object());
        list.add(new Father());
        list.add(new Son());
