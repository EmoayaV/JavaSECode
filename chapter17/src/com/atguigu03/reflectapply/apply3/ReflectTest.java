...
public class ReflectTest {
    ...
    * */
    ...
    public void test2() throws Exception {
        ...
        nameField.set(per,"Tom");//针对实例变量，必须指定是类的哪个对象的实例变量，因为一个类有许多的对象
...
//        System.out.println(infoField.get(Person.class));
        //或 （仅限于类变量可以如下的方式调用）
        infoField.set(null,"我是一个人");//针对类变量，不用指定是哪个类的类变量，因为开始已经传入这个类了
    ...
    public void test4() throws Exception {
        ...
        Method showNationMethod = clazz.getDeclaredMethod("showNation",String.class,int.class);//这里int不能写为integer，因为这里传入的是类型，不是值，值可以自动装箱，类型不能自动装箱。
        ...
        Object returnValue = showNationMethod.invoke(per,"CHN",10); //invoke方法的返回值是object
